sudo rm -f /tmp/AliasM* /tmp/BCRacing* /tmp/BMC* /tmp/Cars* /tmp/Categories* /tmp/ModelCodes* /tmp/QuantumCars.* /tmp/Superchips* /tmp/FIWebsite.* /tmp/FIProducts.* /tmp/FIStoreLayout.* /tmp/ZenCartStoreEntries.*
